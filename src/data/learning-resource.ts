...
export const LearningResourceComponent = () => {
  ...
  return [
    {
      href: "#",
      imgSrc: getAssetPath("images/mockup/growing_mockup.png"),
      alt: "Fast Delivery",
    ...
    {
      href: "#",
      imgSrc: getAssetPath("images/mockup/hivello_mockup.png"),
      alt: "Quality",
    ...
    {
      href: "#",
      imgSrc: getAssetPath("images/mockup/tracki_mockup.png"),
      alt: "Support",
